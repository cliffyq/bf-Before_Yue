	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div
				...
				<div class="controls">
					<input class="span6" type="text" name="email" id="email"
			...
			<div
				...
				<div class="controls">
					<input class="span6" type="text" name="display_name"
						id="display_name" value="<?php echo set_value('display_name'); ?>" />
				</div>
			</div>
			...
			<div
				...
				<div class="controls">
					<input class="span6" type="text" name="username" id="username"
			...
			<div
				...
				<div class="controls">
					<input class="span6" type="password" name="pass_confirm"
						id="pass_confirm" value=""
			...
			<div
				...
				<div class="controls">
					<select name="language" id="language" class="chzn-select">
						...
						<?php echo set_select('language', $language, config_item('language') == $language ? TRUE : FALSE) ?>>
