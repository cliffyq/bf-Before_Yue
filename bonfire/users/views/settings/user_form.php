...
<div
	...
	<fieldset>
		...
		<div
			class="control-group <?php echo form_error('email') ? 'error' : '' ?>">
			<label for="email" class="control-label"><?php echo lang('bf_email') ?>
			</label>
			<div class="controls">
		...
		<div
			class="control-group <?php echo form_error('username') ? 'error' : '' ?>">
			<label for="username" class="control-label"><?php echo lang('bf_username') ?>
			</label>
			<div class="controls">
		...
		<div
			class="control-group <?php echo form_error('display_name') ? 'error' : '' ?>">
			<label for="display_name" class="control-label"><?php echo lang('bf_display_name') ?>
			</label>
			<div class="controls">
		...
		<div
			class="control-group <?php echo form_error('password') ? 'error' : '' ?>">
			<label for="password" class="control-label"><?php echo lang('bf_password') ?>
			</label>
			<div class="controls">
		...
		<div
			class="control-group <?php echo form_error('pass_confirm') ? 'error' : '' ?>">
			<label class="control-label" for="pass_confirm"><?php echo lang('bf_password_confirm') ?>
			</label>
			<div class="controls">
		...
		<div
			class="control-group <?php echo form_error('language') ? 'error' : '' ?>">
			<label class="control-label" for="language"><?php echo lang('bf_language') ?>
			</label>
			<div class="controls">
				<select name="language" id="language" class="chzn-select">
					...
					<?php echo set_select('language', $language, isset($user->language) && $user->language == $language ? TRUE : FALSE) ?>>
		...
		<div
			class="control-group <?php echo form_error('timezone') ? 'error' : '' ?>">
			<label class="control-label" for="timezones"><?php echo lang('bf_timezone') ?>
			</label>
			<div class="controls">
	...
	<fieldset>
		...
		<div class="control-group">
			<label for="role_id" class="control-label"><?php echo lang('us_role'); ?>
			</label>
			<div class="controls">
				<select name="role_id" id="role_id" class="chzn-select">
					...
					<?php echo set_select('role_id', $role->role_id, $default_role) ?>>
	...
	<fieldset>
		<legend>
			<?php echo lang('us_account_status') ?>
		</legend>
		...
		<div class="control-group">
			<div class="controls">
				<label for="<?php echo $field; ?>"> <input type="checkbox"
					name="<?php echo $field; ?>" id="<?php echo $field; ?>" value="1">
		...
		<div class="control-group">
			<div class="controls">
				<label for="restore"> <input type="checkbox" name="restore"
					id="restore" value="1"> <?php echo lang('us_restore_note') ?>
				</label>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="controls">
				<label for="unban"> <input type="checkbox" name="unban" id="unban"
					value="1"> <?php echo lang('us_unban_note') ?>
				</label>
			</div>
		</div>
		<?php endif; ?>
