...
if ( ! function_exists('form_dropdown'))
{
	 ...
	 * @return string A string with the formatted input element, label tag and wrapping divs.
	 */
	function form_dropdown($data, $options=array(), $selected='', $label='',$cg_class='', $additional_class='', $extra='', $tooltip = '')
	{
...
<div class="control-group {$cg_class} {$error}">
	<label class="control-label {$additional_class}" for="{$defaults['name']}">{$label}</label>
	<div class="controls">
		 <select {$output} {$extra}>
			{$options_vals}
		</select>
