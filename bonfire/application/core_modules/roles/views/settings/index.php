	...
	<table class="table table-striped">
		<thead>
			<tr>
				...
				<th class="text-center" style="width: 5em"># <?php echo lang('bf_users'); ?>
				</th>
		...
		<tbody>
			...
			<tr>
				<td><?php echo anchor(SITE_AREA .'/settings/roles/edit/'. $role->role_id, $role->role_name) ?>
				</td>
