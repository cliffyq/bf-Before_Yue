		...
		<tbody>
			...
			<tr title="<?php echo $matrix_perm['name']; ?>">
				...
				<td class="text-center"
					title="<?php echo $cols[$i]['role_name']; ?>"><input
					type="checkbox" value="<?php echo $checkbox_value; ?>"
					<?php echo $checked; ?>
					title="<?php echo lang('matrix_role');?>: <?php echo $cols[$i]['role_name']; ?>, <?php echo lang('matrix_permission');?>: <?php echo $matrix_perm['name']; ?>" />
				</td>
				<?php endif; ?>
				<?php endfor; ?>
			</tr>
