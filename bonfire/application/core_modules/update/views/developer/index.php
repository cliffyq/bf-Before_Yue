	...
	<fieldset>
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					<td><?php echo anchor('http://github.com/'. $commit->author->login, $commit->author->name, array('target' => '_blank')) ?>
					</td>
					<td><?php echo relative_time(strtotime($commit->committed_date)) ?>
					</td>
