		...
		<tfoot>
			<tr>
				<td colspan="3"><?php echo lang('bf_with_selected'); ?>: <input
					type="submit" name="action_delete" id="delete-me"
					class="btn btn-danger"
					value="<?php echo lang('bf_action_delete') ?>"
					onclick="return confirm('<?php echo lang('logs_delete_confirm'); ?>')" />
				</td>
			</tr>
		</tfoot>
		<tbody>
			...
			<tr>
				<td class="column-check"><input type="checkbox"
					value="<?php e($log) ?>" name="checked[]" />
				</td>
				<td><a
					href="<?php e(site_url(SITE_AREA .'/developer/logs/view/'. $log)) ?>">
						<b><?php e(date('F j, Y', strtotime(str_replace('.php', '', str_replace('log-', '', $log)))) ); ?>
					</b>
				</a>
				</td>
				<td><?php e($log) ?></td>
...
<div class="admin-box">
	...
	<div class="form-actions">
		<button type="submit" name="action_delete_all" class="btn btn-danger"
