<div class="admin-box">
	<h3>
		<span style="font-weight: normal">Viewing:</span>
		<?php echo $log_file_pretty; ?>
	</h3>
	...
	<p>
		View &nbsp;&nbsp; <select id="filter">
			<option value="all">
				<?php echo lang('log_show_all_entries'); ?>
			</option>
			<option value="error">
				<?php echo lang('log_show_errors'); ?>
			</option>
		</select>
	</p>
	...
	<div id="log">
		...
		?>
		<div
			style="border-bottom: 1px solid #999; padding: 5px 18px; color: #222;"
...
<div class="admin-box">
	<h3>
		<?php echo lang('log_delete1_button') ?>
	</h3>
	<br />
	...
	<div class="form-actions">
		...
		<button type="submit" name="action_delete" class="btn btn-danger"
			onclick="return confirm('<?php echo lang('log_delete_confirm') ?>')">
