...
<ul class="clean">
	...
	<li><span class="small"><?php echo relative_time(strtotime($activity->created_on)) ?>
	</span> <br /> <b><?php e($identity) ?> </b> <?php echo $activity->activity ?>
	</li>
	<?php endforeach; ?>
</ul>
<?php else : ?>
