<div class="admin-box">
	...
	<table class="table table-striped">
		<thead>
			<tr>
				<th style="width: 2em"><input class="check-all" type="checkbox" />
				</th>
				<th><?php echo lang('db_table_name'); ?></th>
				<th style="width: 5.5em"># <?php echo lang('db_records'); ?>
				</th>
		...
		<tfoot>
			<tr>
				<td colspan="7"><?php echo lang('bf_with_selected'); ?>: <select
					name="action" class="span2" style="margin-bottom: 0;">
						<option>
							<?php echo lang('db_backup'); ?>
						</option>
						<option>
							<?php echo lang('db_repair'); ?>
						</option>
						<option>
							<?php echo lang('db_optimize'); ?>
						</option>
						<option>------</option>
						<option>
							<?php echo lang('db_drop'); ?>
						</option>
				</select> &nbsp;&nbsp; <input type="submit" name="submit"
					value="<?php echo lang('db_apply')?>" class="btn btn-primary" />
				</td>
			</tr>
		</tfoot>
		<tbody>
			...
			<tr>
				<td class="column-check"><input type="checkbox"
					value="<?php e($table->Name) ?>" name="checked[]" />
				</td>
				<td><a
					href="<?php e(site_url(SITE_AREA .'/developer/database/browse/'. $table->Name)) ?>">
						<?php e($table->Name) ?>
				</a>
				</td>
