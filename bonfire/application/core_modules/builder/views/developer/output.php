...
<div class="notification success">
	<p>
		<?php echo lang('mb_out_success'); ?>
	</p>
	<br />
	<p>
		<b><?php echo lang('mb_out_success_note'); ?> </b>
	</p>
</div>
...
<h4>
	<?php echo lang('mb_out_acl'); ?>
</h4>
<p>
	<?php echo sprintf(lang('mb_out_acl_path'),$module_name_lower); ?>
	<?php endif; ?>

	<?php if($build_config): ?>
<h4>
	<?php echo lang('mb_out_config'); ?>
</h4>
<p>
	<?php echo lang('mb_out_config_path'); ?>
</p>
<?php endif; ?>

<h4>
	<?php echo lang('mb_out_controller'); ?>
</h4>
<p>
	<?php
...
<?php if($db_migration): ?>
<h4>
	<?php echo lang('mb_out_migration'); ?>
</h4>
<p>
