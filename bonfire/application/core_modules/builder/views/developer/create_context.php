...
<div class="admin-box">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="context_name" class="input-large"
	...
	<div class="control-group">
		...
		<div class="controls">
			...
			<label class="checkbox"> <input type="checkbox" name="roles[]"
				...
				<?php echo set_checkbox('roles[]', $role->role_id) ?> /> <?php echo $role->role_name; ?>
			</label>
			<?php endforeach; ?>
		</div>
	</div>
	...
	<div class="form-actions">
		<input type="submit" name="submit" class="btn btn-primary"
			value="Create It" /> or <a
			href="<?php echo site_url(SITE_AREA .'/developer/builder') ?>">Cancel</a>
	</div>
