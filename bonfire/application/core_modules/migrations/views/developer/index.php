...
<div class="admin-box">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="#app-tab" data-toggle="tab">Application</a>
		</li>
		<li><a href="#mod-tab" data-toggle="tab">Modules</a>
		</li>
		<li><a href="#core-tab" data-toggle="tab">Bonfire</a>
		</li>
	</ul>
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="app-tab">
			<fieldset>
				<legend>
					<?php echo lang('mig_app_migrations'); ?>
				</legend>
				...
				<div class="alert alert-info fade in">
					<a class="close" data-dismiss="alert">&times;</a>
					<?php echo lang('mig_installed_version'); ?>
					<b><?php echo $installed_version; ?> </b> /
					<?php echo lang('mig_latest_version'); ?>
					<b><?php echo $latest_version ?> </b>
				</div>
				...
				<p>
					...
					<select name="migration">
						...
						<option value="<?php echo (int)substr($migration, 0, 3) ?>"
						<?php echo ((int)substr($migration, 0, 3) == $this->uri->segment(5)) ? 'selected="selected"' : '' ?>>
							<?php echo $migration ?>
						</option>
						<?php endforeach; ?>
					</select>
				...
				<div class="form-actions">
					<input type="submit" name="submit"
						value="<?php echo lang('mig_migrate_button'); ?>" /> or
		...
		<div id="mod-tab" class="tab-pane">
			<fieldset>
				<legend>
					<?php echo lang('mig_mod_migrations'); ?>
				</legend>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td style="width: 35em; text-align: right"><?php echo form_open(site_url(SITE_AREA .'/developer/migrations/migrate_module/'. $module), 'class="form-horizontal"'); ?>
								<input type="hidden" name="is_module" value="1" /> <select
								name="version">
								...
								class="btn btn-primary" value="Migrate Module" /> <?php echo form_close(); ?>
							</td>
						</tr>
						<?php endforeach; ?>
					</tbody>
				...
				<br />
				<div class="alert alert-info fade in ">
					<a class="close" data-dismiss="alert">&times;</a> No modules have
					any migrations available.
				</div>
				<?php endif; ?>
			</fieldset>
		</div>
		...
		<div id="core-tab" class="tab-pane">
			...
			<fieldset>
				<legend>
					<?php echo lang('mig_core_migrations'); ?>
				</legend>
				...
				<div class="alert alert-info fade in ">
					<a class="close" data-dismiss="alert">&times;</a>
					<?php echo lang('mig_installed_version'); ?>
					<b><?php echo $core_installed_version; ?> </b> /
					<?php echo lang('mig_latest_version'); ?>
					<b><?php echo $core_latest_version ?> </b>
				</div>
				...
				<div class="control-group">
					<label class="control-label" for="migration"><?php echo lang('mig_choose_migration'); ?>
					</label>
					<div class="controls">
