<div class="well sidebar-nav">
	<ul class="nav nav-list">
		<li class="nav-header">HOME</li>
				<li <?php echo substr_compare($this->uri->uri_string(),'/company/company_company/video_charts',0) ? 'class="active"' : '' ?>>
				<a href="<?php echo site_url('/company/company_company/video_charts') ?>" id="sidebar-charts">Charts</a>
				</li>

		
		<li class="nav-header">MEDIA</li>
		<li <?php echo   $this->uri->uri_string() == SITE_AREA .'/content/video/create' ? 'class="active"' : '' ?>>
			<a href="<?php echo site_url(SITE_AREA .'/content/video/create') ?>" id="sidebar-new-meida">Upload New Media</a>
		</li>
