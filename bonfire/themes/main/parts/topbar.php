	...
	<div class="navbar-inner">
		...
		<div class="container">
			...
			<a class="btn btn-navbar" data-toggle="collapse"
				...
				title="<?php e($this->settings_lib->item('site.title'))?>"
				class="logo"></a> </a>
			...
			<div class="nav-collapse collapse">
				<ul class="nav pull-right">
					...
					<li class="">
						...
						</button> <!-- Change **light** to **dark** to match colors 
					...
					<li class="">
						...
						<ul class="dropdown-menu "
							...
							<input type="text" name="login" id="login_value"
							...
							<input class="btn btn-success" type="submit" name="submit"
								id="submit" value="Sign In" tabindex="5" />
							<input class="btn btn-primary"
								onClick="location.href='<?= site_url('/register')?>';"
