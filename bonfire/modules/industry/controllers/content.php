...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Industry.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Industry.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_industry())
			{
				...
				Template::redirect(SITE_AREA .'/content/industry');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/industry');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Industry.Content.Edit');
		...
		{
			$this->auth->restrict('Industry.Content.Delete');
