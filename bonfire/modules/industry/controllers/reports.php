...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Industry.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Industry.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_industry())
			{
				...
				Template::redirect(SITE_AREA .'/reports/industry');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/industry');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Industry.Reports.Edit');
		...
		{
			$this->auth->restrict('Industry.Reports.Delete');
