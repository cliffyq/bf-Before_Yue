...
class settings extends Admin_Controller {
	...
	*/
	...
	{
		$this->auth->restrict('Industry.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_industry())
			{
				...
				Template::redirect(SITE_AREA .'/settings/industry');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/industry');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Industry.Settings.Edit');
		...
		{
			$this->auth->restrict('Industry.Settings.Delete');
