		...
		<br/>
		<input type="submit" name="save" class="btn btn-primary" value="Edit addresses" />
				or <?php echo anchor(SITE_AREA .'/developer/addresses', lang('addresses_cancel'), 'class="btn btn-warning"'); ?>
						

			<?php if ($this->auth->has_permission('Addresses.Developer.Delete')) : ?>

					or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php echo lang('addresses_delete_confirm'); ?>')">
							<i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('addresses_delete_record'); ?>
									</button>
