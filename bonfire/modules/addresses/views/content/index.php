<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Addresses.Content.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Addresses.Content.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/content/addresses/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->addresses_zip) ?></td>
						<?php else: ?>
