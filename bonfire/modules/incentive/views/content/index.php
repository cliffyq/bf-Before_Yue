	...
	<table class="table table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/content/incentive/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->incentive_company_id) ?>
				</td>
				<?php else: ?>
				<td><?php echo $record->incentive_company_id ?>
				</td>
				<?php endif; ?>

				<td><?php echo $record->incentive_name?>
				</td>
				<td><?php echo $record->incentive_description?>
				</td>
				<td><?php echo $record->incentive_price?>
				</td>
				<td><?php echo $record->incentive_image_path?>
				</td>
				<td><?php echo $record->incentive_amount_left?>
				</td>
				<td><?php echo $record->incentive_amount_total?>
				</td>
				<td><?php echo $record->created_on?>
				</td>
				<td><?php echo $record->modified_on?>
				</td>
			</tr>
			<?php endforeach; ?>
			<?php else: ?>
