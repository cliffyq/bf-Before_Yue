					...
					<div class="incentive_control_group"<?php echo form_error('incentive_description') ? 'error' : ''; ?>">
						...
						<div>
							<textarea id="incentive_description" type="text"
								...
								value="<?php echo set_value('incentive_description', isset($incentive['incentive_description']) ? $incentive['incentive_description'] : ''); ?>"> </textarea>
				...
				<div class="incentive_rightpart">
					...
					<div class="incentive_control_group"<?php echo form_error('incentive_category_id') ? 'error' : ''; ?>">
						...
						<div class='incentive_preview_image'>
							<img id="incentive_preview_image" src="" alt="your image" /> <span
			...
			<div class=span8>
				...
				<div class="incentive_rightpart">
					...
					<div class="incentive_control_group"<?php echo form_error('incentive_amount_left') ? 'error' : ''; ?>">
						<?php echo form_label('Amount', 'incentive_amount_left' ); ?>
						<div>
							<input id="incentive_amount_left" class='incentive_amount' type="text" name="incentive_amount_left"
								maxlength="11"
