...
<h3>
	<?php echo $video_records->video_title ?>
</h3>
...
<video id="video_1" class="video-js vjs-default-skin" controls
	...
	<source
		src=<?=base_url().VIDEO_UPLOAD_PATH.$video_records->video_path."video.mp4" ?>
		type='video/mp4' />
...
<fieldset>
	<form>
		...
		<p>
			<input type="text" id="username" size="60" /> username
...
<table class="table table-striped">
	...
	<tfoot>
		...
		<tr>
			<td colspan="8"><?php echo lang('bf_with_selected') ?> <input
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo anchor(SITE_AREA .'/content/comment/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->comment_user) ?>
			</td>
			<?php else: ?>
