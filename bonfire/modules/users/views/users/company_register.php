	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="control-group offset1">
				<label class="control-label required" for="company_name"><?php echo lang('bf_company_name'); ?>
				</label>
				<div class="controls">
					<input class="input-xlarge" type="text" name="company_name"
						id="company_name" required="required" />
				</div>
			</div>


			<div class="control-group offset1">
				<label class="control-label required" for="company_logo"><?php echo lang('bf_company_logo'); ?>
				</label>
				<div class='controls'>
			...
			<div class="control-group offset1">
				<label class="control-label required" for="company_url"><?php echo lang('bf_company_url'); ?>
				</label>
				<div class='controls'>
					<input id="company_url" class="input-xlarge" type="text"
						name="company_url" maxlength="255"
						value="<?php echo set_value('company_url', isset($company['company_url']) ? $company['company_url'] : ''); ?>" />
					<span class="help-inline"><?php echo form_error('company_url'); ?>
					</span>
				</div>
			...
			<div class="control-group offset1">
				<label class="control-label required" for="company_description"><?php echo lang('bf_company_description'); ?>
				</label>

				<div class='controls'>
					<input id="company_description" class="input-xlarge" type="text"
