	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="span4" type="text" name="company_name" id="company_name"  placeholder="<?php echo lang('bf_company_name'); ?>" required="required" />
				</div>
			</div>
			...
			<?php echo form_dropdown('company_industry_id', $company_industry_dropdown,'',lang('bf_company_industry_id'),'required',$company_industry_dropdown_class);?>
