	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="control-group offset1">
				...
				<div class="controls">
					<input id="birth_month" type="text" name="birth_month" class="input-xlarge" data-date-format="mm/yyyy" data-date-viewmode="1" data-date-minviewmode="2" value="<?php echo set_value('birth_month') ?>" />
				</div>
			</div>
			<div class="control-group offset1">
			...
			<div class="control-group offset1">
				...
				<div class="controls"> 
					<select id="race" class="input-xlarge dropdown-register" name="race" value="<?php echo set_value('race') ?>">
