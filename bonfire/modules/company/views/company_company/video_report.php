...
<div class="reports">
	...
	<h3>Review History:	
		...
		<a href="<?=base_url()?>company/company_company/export_csv/review/<?=$video_info['id']?>" class="pull-right btn btn-primary">Download Report</a>
	</h3>
	...
	<div class="table-report">					
		<table class='table table-striped'>
			...
			<tbody>	
				...
				<tr>
					<td><?= isset($review_history['gender'])?$review_history['gender']:''?></td>
