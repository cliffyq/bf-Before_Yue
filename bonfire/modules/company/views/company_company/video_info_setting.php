<div class="info_video_general">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="video_upload" type="text" name="video_title" class="span6"
				value="<?=$video_info->video_title?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea id="video_upload" name="video_description" class="span6"
				type="text">
	...
	<div class="control-group">
		<div class="controls">
			<input class="btn btn-primary  change_submit" type="submit"
				name="submit" id="submit" value="save changes"> <a class="btn">cancel</a>
			<a class="btn btn-danger offset1"
				href="<?=site_url('company/company_company/video_deleting').'/'.$video_info->id.'/'.$video_info->video_path?>">delete
				this video</a>
		</div>
	</div>
