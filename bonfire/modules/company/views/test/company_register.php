	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div
				...
				<div class="controls">
					<input class="span4" type="text" name="email" id="email"
						value="<?php echo set_value('email'); ?>"
						placeholder="<?php echo lang('bf_email'); ?>" required="required" />
				</div>
			</div>
			...
			<div
				...
				<div class="controls">
					<input class="span4" type="text" name="username" id="username"
						value="<?php echo set_value('username') ?>"
						placeholder="<?php echo lang('bf_username'); ?>"
						required="required" />
				</div>
			</div>
			...
			<div
				...
				<div class="controls">
					<input class="span4" type="password" name="password" id="password"
						value="" placeholder="<?php echo lang('bf_password'); ?>"
						required="required" />
				</div>
			</div>
			...
			<div
				...
				<div class="controls">
					<input class="span4" type="password" name="pass_confirm"
			...
			<div class="control-group">
				<label class="control-label" for="industry_id"><?php echo lang('bf_industry'); ?>
				</label>
				<div class="controls">
