<div class="admin-box">
	...
	<table class="table table-striped">
		...
		<tfoot>
			...
			<tr>
				<td colspan="6"><?php echo lang('bf_with_selected') ?> <input
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/developer/company/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->company_name) ?>
				</td>
				<?php else: ?>
