<div class="video_card">
		...
		<div class='video_data'>
			...
			<div class='metadata'>
				...
				<div class="company">
				Company: <img src="<?php echo modules::run('company/get_logo', $company->company_logo)?>" alt="Company logo" height="20px" class = "logo"/><?php echo anchor_popup($company->company_url, $company->company_name) ?> 
				</div>
