		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="video_set_info">
					<div class="control-group">
						<label class="control-label required" for="email">Select media
							thumbnail:</label>
						<div class="controls"></div>
					</div>
					<div class="control-group">
						<label class="control-label required" for="email">Enter media
							information:</label>
						<div class="controls">
							<label>Title:</label> <input class="video_upload_title span6"
								type="text"></input> <label>Descripstion:</label>
							<textarea class="video_upload_information span6" type="text"></textarea>
							<label>Tags:</label> <input class="video_upload_title span6"
								type="text"></input>
						</div>
					</div>
					<div class="control-group">
