	...
	<table class="table table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/content/video/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->video_title) ?>
				</td>
				<?php else: ?>
				...
				<td><?php echo anchor(SITE_AREA .'/content/video/view/'.$record->id, 'show') ?>
				</td>
				<?php else: ?>
