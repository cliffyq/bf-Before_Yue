<div class="admin-box">
	...
	<table class="table table-striped">
		...
		<tfoot>
			...
			<tr>
				<td colspan="15"><?php echo lang('bf_with_selected') ?> <input
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/commonauth/user_info/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->user_info_user_id) ?>
				</td>
				<?php else: ?>
