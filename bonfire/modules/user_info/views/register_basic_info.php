<div>
	<label>First Name</label> <input id='first_name' type='text'></input>
</div>

<div>
	<label>Last Name</label> <input id='first_name' type='text'></input>
</div>
...
<div>
	<label>Birth Month</label> <select>
		<?php for($i=1; $i<=12; $i++){
...
<div>
	<label>Veteran</label> <input type="checkbox">Yes</input>
</div>
